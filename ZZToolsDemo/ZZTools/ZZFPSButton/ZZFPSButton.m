...
@implementation ZZFPSButton {
    CADisplayLink *_link;
    NSUInteger _count;
    NSTimeInterval _lastTime;
}

+ (instancetype)setTouchWithFrame:(CGRect)frame titleFont:(UIFont *)titleFont backgroundColor:(UIColor *)backgroundColor backgroundImage:(UIImage *)backgroundImage {
...
- (instancetype)initWithframe:(CGRect)frame titleFont:(UIFont *)titleFont backgroundColor:(UIColor *)backgroundColor backgroundImage:(UIImage *)backgroundImage {
