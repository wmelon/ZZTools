...
@interface ZZPhotoPickerVC (){
    ...
    BOOL _pushPhotoPickerVc, _didPushPhotoPickerVc; // 是否直接跳转
}
/**默认的列数*/
...
//- (void)loadTheSelectedData:(void (^)(NSArray<UIImage *> * _Nonnull, NSArray<NSURL *> * _Nonnull, NSArray<PHAsset *> * _Nonnull, NSArray<NSDictionary *> * _Nonnull, ZZPhotoPickerSourceType, NSError * _Nonnull))selectedHandler {
//    self.albumVc.selectedHandler = selectedHandler;
//    self.photoVc.selectedHandler = selectedHandler;
//}
