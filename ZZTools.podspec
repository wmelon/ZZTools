...
s.name				        = "ZZTools"
s.version			        = "1.3.0"
s.summary			        = "一些通用工具, 包括:瀑布流, 星星评价, 页面路由等, 详细见: https://github.com/An-iOSer/ZZTools"
s.description			    = "1.瀑布流：自定义collectionView的布局，提供垂直＆水平＆浮动;水平＆多状态混合瀑布流效果（可实现淘宝SKU选择的浮动效果）, 支持设置不同分区不同背景颜色。2.星星评价：可自定义星星数量，分级，最低分，支持拖曳手势，支持半颗星（同样支持小数，最低0.01）。3.页面路由：模块解耦，组件化必备，用法简单，支持正向传值以及反向传值，无需继承，侵入性低。"
...
# ―――――――――――――――――――――――――――――――  Subspecs ――――――――――――――――――――――――――――――――――――#
  ...
  s.subspec 'ZZFPSButton' do |ss|
    ss.source_files         = 'ZZToolsDemo/ZZTools/ZZFPSButton/ZZFPSButton.{h,m}'
    ss.public_header_files     = 'ZZToolsDemo/ZZTools/ZZFPSButton/ZZFPSButton.h'
  end
  
  s.subspec 'ZZExtension' do |ss|
    ss.source_files         = 'ZZToolsDemo/ZZTools/ZZExtension/*.{h,m}'
    ss.public_header_files     = 'ZZToolsDemo/ZZTools/ZZExtension/ZZExtension.h'
  end
